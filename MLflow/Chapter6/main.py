...
# Mlflow empower ds to incorporate their qwn algorithms , custom logic and external
# libraries seamsessly into model build process

# Custom Flavors
# Allows for the creation of custom serialization and deselization logic for model packing and deployment
...
if __name__ == "__main__":
    ...
    ld = mlflow.pyfunc.load_model(model_uri="runs:/f8705cdb846b42c9b84c1a9ab6fb48cf/sklear_mlflow_pyfunc")
...
# f8705cdb846b42c9b84c1a9ab6fb48cf