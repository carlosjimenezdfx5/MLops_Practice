...
# start_run() : Starts a new MLflow run in a experiment under which all the entities will be logged
#   Params :
#       -> run_id
#       -> experiment_id
#       -> run_name
...
def run_model(args):
    ...
    try:
        ...
        train, test = train_test_split(data.sample(1000),
        ...
        #         experiment_id=get_id.experiment_id,
        #         run_name='run_1'
        # ):
        with mlflow.start_run(run_id='8fab8169feef48c68e4f9e0af2727caa'):
